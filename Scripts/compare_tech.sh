...
./clean_build.sh
./bin/acoustic_engine -w ./results_omp

./config.sh -t dpc -i on
./clean_build.sh
./bin/acoustic_engine -w ./results_dpc_cpu -p ./data/computation_parameters_dpc_cpu.txt
./bin/acoustic_engine -w ./results_dpc_gpu -p ./data/computation_parameters_dpc_gen9.txt
