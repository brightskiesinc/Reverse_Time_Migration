...
#ifndef ACOUSTIC2ND_RTM_IMAGE_WRITER_H
#define ACOUSTIC2ND_RTM_IMAGE_WRITER_H
...
public:
  ImageWriter(uint show_each, bool write_velocity, bool write_forward,
              ...
              float percentile, string write_path) : WriterCallback(show_each, write_velocity, write_forward,
...
#endif // ACOUSTIC2ND_RTM_IMAGE_WRITER_H
