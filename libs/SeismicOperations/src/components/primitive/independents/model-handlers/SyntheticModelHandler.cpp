...
GridBox *SyntheticModelHandler::ReadModel(map<string, string> file_names) {
...
void SyntheticModelHandler::Initialize(map<string, string> file_names) {
    string file_name = file_names["velocity"];
