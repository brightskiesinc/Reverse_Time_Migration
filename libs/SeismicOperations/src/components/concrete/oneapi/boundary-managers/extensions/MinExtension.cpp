...
void MinExtension::VelocityExtensionHelper(float *property_array,
    ...
    if (ny == 1) {
        ...
        start_y = 0;
        OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
            cgh.single_task<class min_get_min_velocity>([=]() {
        ...
        OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
            ...
            cgh.parallel_for<class Min_velocity_extension_Y>(
    ...
    OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
        ...
        cgh.parallel_for<class Min_velocity_extension_X>(
                global_nd_range, [=](nd_item<3> it) {
    ...
    OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
        ...
        cgh.parallel_for<class Min_velocity_extension_Z>(
                global_nd_range, [=](nd_item<3> it) {
                    int column = it.get_global_id(0) + start_x;
                    int depth = it.get_global_id(1) + start_y;
    ...
    OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
        ...
        cgh.parallel_for<class Min_velocity_corner_X_Z>(
                global_nd_range, [=](nd_item<3> it) {
                    int column = it.get_global_id(0);
                    int depth = it.get_global_id(1) + start_y;
                    int row = it.get_global_id(2);
    ...
    if (ny > 1) {
        ...
        OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
            ...
            cgh.parallel_for<class Min_velocity_corner_Y_Z>(
                    global_nd_range, [=](nd_item<3> it) {
                        int column = it.get_global_id(0) + start_x;
                        int depth = it.get_global_id(1);
                        int row = it.get_global_id(2);
        ...
        OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
            ...
            cgh.parallel_for<class Min_velocity_corner_X_Y_0>(
                    global_nd_range, [=](nd_item<3> it) {
                        int column = it.get_global_id(0);
                        int depth = it.get_global_id(1);
                        int row = it.get_global_id(2) + start_z;
        ...
        OneAPIBackend::GetInstance()->GetDeviceQueue()->submit([&](handler &cgh) {
            ...
            cgh.parallel_for<class Min_velocity_corner_X_Y_1>(
                    global_nd_range, [=](nd_item<3> it) {
                        int column = it.get_global_id(0);
                        int depth = it.get_global_id(1);
                        int row = it.get_global_id(2) + start_z;
