...
namespace operations {
    namespace common {
        ...
        public:
            ...
            inline float GetMaxPropagationFrequency() const {
                return this->mMaxPropagationFrequency;
            }

            inline void SetMaxPropagationFrequency(float aMaxPropagationFrequency) {
                this->mMaxPropagationFrequency = aMaxPropagationFrequency;
            }
        ...
        private:
            ...
            /// Maximum frequency supported for the propagation.
            float mMaxPropagationFrequency;
