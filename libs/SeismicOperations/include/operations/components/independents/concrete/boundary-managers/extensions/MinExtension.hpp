...
#ifndef OPERATIONS_LIB_COMPONENTS_EXTENSIONS_MIN_EXTENSION_HPP
#define OPERATIONS_LIB_COMPONENTS_EXTENSIONS_MIN_EXTENSION_HPP
...
#endif // OPERATIONS_LIB_COMPONENTS_EXTENSIONS_MIN_EXTENSION_HPP
