...
#ifndef OPERATIONS_LIB_HELPERS_CALLBACKS_SU_WRITER_H
#define OPERATIONS_LIB_HELPERS_CALLBACKS_SU_WRITER_H
        ...
        namespace callbacks {
            ...
            public:
                SuWriter(uint show_each, bool write_velocity, bool write_forward,
                         ...
                         const std::string &write_path, bool write_little_endian_su)
                        : WriterCallback(show_each,
                                         write_velocity,
                                         write_forward,
                                         write_backward,
                                         write_reverse,
                                         ...
                                         write_path, "su") {
                    this->mIsWriteLittleEndian = write_little_endian_su;
                };
...
#endif // OPERATIONS_LIB_HELPERS_CALLBACKS_SU_WRITER_H
