...
#ifndef OPERATIONS_LIB_HELPERS_CALLBACKS_BINARY_WRITER_H
#define OPERATIONS_LIB_HELPERS_CALLBACKS_BINARY_WRITER_H
...
#endif // OPERATIONS_LIB_HELPERS_CALLBACKS_BINARY_WRITER_H
