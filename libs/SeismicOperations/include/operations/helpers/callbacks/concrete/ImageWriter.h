...
#ifndef OPERATIONS_LIB_HELPERS_CALLBACKS_IMAGE_WRITER_H
#define OPERATIONS_LIB_HELPERS_CALLBACKS_IMAGE_WRITER_H
...
namespace operations {
    namespace helpers {
        namespace callbacks {
            ...
            class ImageWriter : public WriterCallback {
            public:
                ImageWriter(uint show_each, bool write_velocity, bool write_forward,
                            ...
                            float percentile, const std::string &write_path)
                        : WriterCallback(show_each, write_velocity,
                                         write_forward,
                                         write_backward,
                                         write_reverse,
                                         write_migration,
                                         ...
                                         write_traces_raw,
                                         writer_traces_preprocessed,
                                         vec_params,
                                         vec_re_extended_params,
                                         write_path, "images") {
                    this->mPercentile = percentile;
                };
...
#endif // OPERATIONS_LIB_HELPERS_CALLBACKS_IMAGE_WRITER_H
