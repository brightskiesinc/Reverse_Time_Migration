...
LoggerChannel::LoggerChannel(LoggerCollection *aCollection, Operation aOperation) {
    this->mOperationType = aOperation;
    this->mpCollection = aCollection;
}

LoggerChannel::~LoggerChannel() = default;
