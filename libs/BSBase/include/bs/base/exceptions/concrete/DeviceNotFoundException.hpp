...
#define BS_BASE_EXCEPTIONS_DEVICE_NOT_FOUND_EXCEPTION_HPP

#include <bs/base/exceptions/interface/BaseException.hpp>

#define DEVICE_NOT_FOUND_EXCEPTION() \
DeviceNotFoundException(__FILE__, __LINE__, __FUNCTION__)

#define DEVICE_NOT_FOUND_EXCEPTION_WITH_MESSAGE(MESSAGE) \
...
namespace bs {
    namespace base {
        namespace exceptions {
            ...
            class DeviceNotFoundException : public BaseException {
            public:
                DeviceNotFoundException(const char *aFileName,
                                        int aLineNumber,
                                        const char *aFunctionName,
                                        const char *aAdditionalInformation = nullptr)
                        : BaseException("Device Not Found Exception: No device found.",
...
#endif //BS_BASE_EXCEPTIONS_DEVICE_NOT_FOUND_EXCEPTION_HPP
