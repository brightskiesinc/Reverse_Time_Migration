...
vector<uint>
SEGYIOManager::GetUniqueOccurences(string file_name, string key_name, uint min_threshold, uint max_threshold) {
...
void SEGYIOManager::ReadSelectiveDataFromFile(string file_name, string sort_type, SeIO *sio, int cond) {
