...
#ifndef THOTH_STREAMS_CSV_WRITER_HPP
#define THOTH_STREAMS_CSV_WRITER_HPP
...
namespace thoth {
    namespace streams {
        ...
        public:
            explicit CSVWriter(thoth::configuration::ConfigurationMap *apConfigurationMap);
...
#endif //THOTH_STREAMS_CSV_WRITER_HPP
