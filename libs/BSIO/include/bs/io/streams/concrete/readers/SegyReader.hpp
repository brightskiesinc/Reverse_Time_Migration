...
#ifndef BS_IO_STREAMS_SEGY_READER_HPP
#define BS_IO_STREAMS_SEGY_READER_HPP
    ...
    namespace io {
        namespace streams {
            ...
            public:
                 ...
                 * @brief Constructor
                 */
                explicit SegyReader(bs::base::configurations::ConfigurationMap *apConfigurationMap);
...
#endif //BS_IO_STREAMS_SEGY_READER_HPP
