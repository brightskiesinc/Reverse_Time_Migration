...
#define BS_IO_STREAMS_BINARY_WRITER_HPP
    ...
    namespace io {
        namespace streams {
            ...
            public:
                 ...
                 * @brief Constructor.
                 */
                explicit BinaryWriter(bs::base::configurations::ConfigurationMap *apConfigurationMap);
...
#endif //BS_IO_STREAMS_BINARY_WRITER_HPP
