...
#ifndef BS_IO_STREAMS_CSV_WRITER_HPP
#define BS_IO_STREAMS_CSV_WRITER_HPP
    ...
    namespace io {
        namespace streams {
            ...
            public:
                 ...
                 * @brief Constructor.
                 */
                explicit CSVWriter(bs::base::configurations::ConfigurationMap *apConfigurationMap);
...
#endif //BS_IO_STREAMS_CSV_WRITER_HPP
