...
#include <bs/io/lookups/mappers/PSGHeaderMapper.hpp>
...
std::unordered_map<bs::io::dataunits::TraceHeaderKey::Key,
        std::pair<size_t, NATIVE_TYPE>> PSGHeaderMapper::mLocationTable = {
        ...
        {TraceHeaderKey::DATA_BYTE_OFFSET, {180, NATIVE_TYPE::UNSIGNED_INT}},
};
