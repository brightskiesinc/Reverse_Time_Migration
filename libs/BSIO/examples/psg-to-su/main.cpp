...
int main(int argc, char *argv[]) {
    ...
    std::vector<TraceHeaderKey> gather_keys = {TraceHeaderKey::SX};
    std::vector<std::pair<TraceHeaderKey, Gather::SortDirection>> sorting_keys;
    std::vector<std::string> paths = {WRITE_PATH "/shots_.psg",};

    SeismicReader sr(
            SeismicReader::ToReaderType("psg"),
