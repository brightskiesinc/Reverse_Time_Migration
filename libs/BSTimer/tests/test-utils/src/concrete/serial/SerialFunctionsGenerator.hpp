...
#ifndef BS_TIMER_TESTS_UTILS_SERIAL_FUNCTIONS_GENERATOR_HPP
#define BS_TIMER_TESTS_UTILS_SERIAL_FUNCTIONS_GENERATOR_HPP
...
#endif //BS_TIMER_TESTS_UTILS_SERIAL_FUNCTIONS_GENERATOR_HPP
