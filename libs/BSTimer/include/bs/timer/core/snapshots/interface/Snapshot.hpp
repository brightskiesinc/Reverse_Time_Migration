...
#ifndef BS_TIMER_CORE_SNAPSHOT_HPP
#define BS_TIMER_CORE_SNAPSHOT_HPP
    ...
    namespace timer {
        namespace core {
            namespace snapshots {
                ...
                /**
                 * @brief Snapshot class used to hold start and end points of execution timer,
                 * until time of resolving and runtime calculation.
                 */
                class Snapshot {
                public:
                    /**
...
#endif // BS_TIMER_CORE_SNAPSHOT_HPP
