...
#include "min_extension.h"
#include <algorithm>
#include <cstdlib>

using namespace std;

void MinExtension::velocity_extension_helper(float *property_array, int start_x,
...
void MinExtension::top_layer_extension_helper(float *property_array,
...
void MinExtension::top_layer_remover_helper(float *property_array, int start_x,
