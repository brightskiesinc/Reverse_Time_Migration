...
* Using gcc compiler **(Not Recommended)**
    ...
    ```
  This is will run the RTM using OpenMP technology and gcc compiler and without OpenCV. **For OpenCV, add '--images' to
  enable OpenCV**. For more details about the options for the config script,
